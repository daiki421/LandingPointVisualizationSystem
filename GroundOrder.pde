...
void setup() {
  ...
  fill(255);
  // 左足矢印
  //drawArrow(145, 635, 220, 360); // 1-3
  //drawArrow(145, 635, 80, 410); // 1-2
  //drawArrow(145, 635, 90, 280); // 1-4
  //drawArrow(145, 635, 210, 240); // 1-5
  //drawArrow(100, 365, 200, 340); // 2-3
  //drawArrow(65, 345, 60, 310); // 2-4
  //drawArrow(100, 365, 210, 240); // 2-5
  //drawArrow(200, 340, 100, 365); // 3-2
  //drawArrow(200, 340, 90, 290); // 3-4
  //drawArrow(230, 295, 230, 245); // 3-5
  //drawArrow(60, 310, 65, 345); // 4-2
  //drawArrow(90, 290, 190, 320); // 4-3
  //drawArrow(85, 290, 200, 220); // 4-5
  //drawArrow(210, 240, 100, 365); // 5-2
  //drawArrow(230, 245, 230, 295); // 5-3
  //drawArrow(200, 220, 85, 290); // 5-4
  // 右足矢印
  //drawArrow(645, 635, 570, 370); // 1-3
  //drawArrow(645, 635, 715, 410); // 1-2
  //drawArrow(645, 635, 590, 240); // 1-5
  //drawArrow(645, 635, 700, 290); // 1-4
  //drawArrow(715, 400, 645, 635); // 2-1
  //drawArrow(690, 360, 600, 340); // 2-3
  //drawArrow(690, 360, 580, 245); // 2-5
  //drawArrow(730, 340, 735, 310); // 2-4
  //drawArrow(600, 330, 690, 360); // 3-2
  //drawArrow(600, 330, 700, 300); // 3-4
  //drawArrow(565, 295, 565, 250); // 3-5
  //drawArrow(735, 300, 730, 340); // 4-2
  //drawArrow(710, 300, 605, 325); // 4-3
  //drawArrow(710, 285, 605, 230); // 4-5
  //drawArrow(580, 240, 690, 360); // 5-2
  //drawArrow(565, 245, 565, 295); // 5-3
  //drawArrow(590, 230, 710, 285); // 5-4
}
